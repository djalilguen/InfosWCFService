...
public class ObjectFactory {
    ...
    private final static QName _Article_QNAME = new QName("http://schemas.datacontract.org/2004/07/InfosWCFService", "Article");
    private final static QName _ArrayOfArticle_QNAME = new QName("http://schemas.datacontract.org/2004/07/InfosWCFService", "ArrayOfArticle");
    ...
    private final static QName _AddArticleArt_QNAME = new QName("http://tempuri.org/", "art");
    ...
    private final static QName _ArticleText_QNAME = new QName("http://schemas.datacontract.org/2004/07/InfosWCFService", "text");
    private final static QName _ArticleTitle_QNAME = new QName("http://schemas.datacontract.org/2004/07/InfosWCFService", "title");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/InfosWCFService", name = "Article")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/InfosWCFService", name = "ArrayOfArticle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "art", scope = AddArticle.class)
    public JAXBElement<Article> createAddArticleArt(Article value) {
        return new JAXBElement<Article>(_AddArticleArt_QNAME, Article.class, AddArticle.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "art", scope = GetAllArticles.class)
    public JAXBElement<Article> createGetAllArticlesArt(Article value) {
        return new JAXBElement<Article>(_AddArticleArt_QNAME, Article.class, GetAllArticles.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/InfosWCFService", name = "text", scope = Article.class)
    public JAXBElement<String> createArticleText(String value) {
        return new JAXBElement<String>(_ArticleText_QNAME, String.class, Article.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/InfosWCFService", name = "title", scope = Article.class)
    public JAXBElement<String> createArticleTitle(String value) {
        return new JAXBElement<String>(_ArticleTitle_QNAME, String.class, Article.class, value);
    }
